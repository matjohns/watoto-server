...
try {
  ...
  die(json_encode(array(
    ...
    'drugs' => array(
      'totals' => getKeyValue('SELECT v.what AS key, SUM(v.num) AS value FROM visited v JOIN ping p ON v.uuid = p.uuid WHERE v.type = \'drug\' AND p.time_received > 1464034000 AND p.device_platform_os = \'android\' AND device_emulator = 0 GROUP BY 1 ORDER BY 2 DESC;'),
